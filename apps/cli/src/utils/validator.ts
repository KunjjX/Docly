 ...
 */
export function validateProjectData(projectData: any) {
  const errors = [];
 ...
 */
export function validateMarkdown(content: any) {
 ...
 * Validates file path
 */
export function validateFilePath(filePath: any) {
 ...
 */
export function validateDocType(type: any) {
  const validTypes = [
    'readme',
    'srs',
    'architecture',
