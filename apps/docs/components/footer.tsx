...
export function Footer() {
    return (
        <footer className="bg-[var(--background)] border-t border-[var(--border)] pt-16 pb-12">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
                    ...
                    <div className="col-span-2">
                        ...
                        <p className="text-sm text-[var(--subtext)] max-w-xs mb-6">
                            The intelligent documentation platform for modern engineering
                            teams.
                        </p>
                        <div className="flex gap-4">
                            {/* Twitter / X */}
                            <a
                                href="https://x.com/KunjJarsaniya"
                                className="text-[var(--subtext)] hover:text-[var(--foreground)] transition-colors"
                            >
                            ...
                            {/* LinkedIn */}
                            <a
                                href="https://www.linkedin.com/in/kunj-jarsaniya07/"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-[var(--subtext)] hover:text-[var(--foreground)] transition-colors"
                            >
                ...
                <div className="border-t border-[var(--border)] pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-sm text-[var(--subtext)]">
                        © {new Date().getFullYear()} Docly Inc. All rights reserved.
                    </p>
